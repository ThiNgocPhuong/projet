<?php
    ...
    try
    {
        ...
        $requete=$objetPDO->prepare('INSERT INTO Realisation (photo, titre_realisation,description_realisation, date_debut_realisation, date_fin_realisation)  VALUES (:photo, :titre, :description, :debut, :fin)');
